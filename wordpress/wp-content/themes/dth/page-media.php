<?php
/**
 * Template: media (จาก media.html) — คงหน้าตาและสคริปต์เดิม
 */
get_header();
?>
...
<script>
  ...
  (function(){
    ...
    const names={all:'ทั้งหมด',rights:'สิทธิและสวัสดิการ',law:'กฎหมาย',home:'ที่อยู่อาศัย',magazine:'วารสาร DTH'};
    const subOf={};
    ...
    if(sel)sel.addEventListener('change',()=>{cat=sel.value||'all';apply();});

<?php
/**
 * Template: magazine (จาก magazine.html) — คงหน้าตาและสคริปต์เดิม
 */
get_header();
?>
...
<nav class="breadcrumb" aria-label="เส้นทางนำทาง">
  <div class="wrap"><a href="<?php echo esc_url( home_url('/') ); ?>">หน้าแรก</a> <span aria-hidden="true">›</span> <span>ข้อมูลสำคัญ</span> <span aria-hidden="true">›</span> <strong>DTH Magazine</strong></div>
</nav>
...
<section class="block">
  <div class="wrap">
    ...
    <div class="mag-grid">
      <a class="card mag-card" href="<?php echo DTH_URI; ?>/Doc/magazine/dth-magazine-vol13.pdf" target="_blank" rel="noopener">
      ...
      <a class="card mag-card" href="<?php echo DTH_URI; ?>/Doc/magazine/dth-magazine-vol14.pdf" target="_blank" rel="noopener">
        <span class="mag-ic" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M14 2H7a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7Z"/><path d="M14 2v5h5"/><path d="M9 13h6M9 17h6"/></svg></span>

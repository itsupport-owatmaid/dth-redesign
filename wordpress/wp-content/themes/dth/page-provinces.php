<?php
/**
 * Template: provinces (จาก provinces.html) — คงหน้าตาและสคริปต์เดิม
 */
get_header();
?>
...
<header class="site" id="top">
  <div class="nav">
    ...
    <nav class="nav-pill" id="menu" aria-label="เมนูหลัก">
      ...
      <div class="has-sub">
        <a href="<?php echo esc_url( home_url('/') ); ?>#network" class="active" aria-haspopup="true" aria-expanded="false">เครือข่าย <span class="caret" aria-hidden="true">▾</span></a>
        <div class="sub">
...
<nav class="breadcrumb" aria-label="เส้นทางนำทาง">
  <div class="wrap"><a href="<?php echo esc_url( home_url('/') ); ?>">หน้าแรก</a> <span aria-hidden="true">›</span> <span>เครือข่าย</span> <span aria-hidden="true">›</span> <strong>สภาฯ ประจำจังหวัด</strong></div>
</nav>

<!-- ===== Page hero ===== -->
<section class="page-hero">
  <h1>สภาคนพิการทุกประเภทประจำจังหวัด</h1>
  <p class="lead">รายชื่อคณะกรรมการสภาคนพิการประจำจังหวัด แบ่งตามภูมิภาค — สมาชิกสามัญทั่วไปของสมาคมสภาคนพิการทุกประเภทแห่งประเทศไทย</p>
</section>
